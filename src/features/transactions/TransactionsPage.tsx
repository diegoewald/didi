  ...
  return (
    <div className="space-y-6">
      <div className="card p-5 sm:p-6">
        ...
        <p className="mt-2 max-w-2xl text-sm font-medium leading-6 text-slate-600 dark:text-slate-300">Cadastre, edite, duplique, filtre e marque movimentações como pagas.</p>
      </div>
