...
export function MobileNav({ current, navigate }: { current: string; navigate: (path: string) => void }) {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-40 grid grid-cols-5 border-t border-slate-200/80 bg-white/90 px-2 pb-3 pt-2 shadow-[0_-18px_50px_rgba(15,23,42,.10)] backdrop-blur-2xl dark:border-slate-800/80 dark:bg-slate-950/90 lg:hidden">
      {visible.map((route) => {
